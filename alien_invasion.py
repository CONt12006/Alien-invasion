...
class AlienInvasion:
    ...
    def _check_play_button(self,mouse_pos):
        """Запускает новую игры при нажатии кнопки ИГРАТЬ"""
    ...
    def _fire_bullet(self):
        """Создание нового снаряда и включение на экране его в группу bullets."""
    ...
    def _update_bullets(self):
        ...
        # Проверка попаданий пуль в прищельцев
    ...
    def _create_fleet(self):
        ...
        # Создание пришельца и вычисление колличества прищельцев в ряду
        # Интревал между соседними пришельцами равен ширине пришельца.
        alien=Alien(self)
    ...
    def _check_fleet_edges(self):
        """Реагирут на достижение пришельцем края экрана"""
        for alien in self.aliens.sprites():
